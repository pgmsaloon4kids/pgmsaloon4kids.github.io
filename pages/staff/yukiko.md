...
![スコープ remix]({{ site.baseurl }}/assets/images/staff/{{ page.author }}/01.png)
...
![漢字謎解きアクション「勇」の冒険]({{ site.baseurl }}/assets/images/staff/{{ page.author }}/02.png)
...
![株式売買ゲーム]({{ site.baseurl }}/assets/images/staff/{{ page.author }}/03.png)
...
![Lissajous figure test - リサジューテスト]({{ site.baseurl }}/assets/images/staff/{{ page.author }}/lissajous.gif)
